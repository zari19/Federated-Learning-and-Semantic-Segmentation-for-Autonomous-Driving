...
def get_parser():
    ...
    parser.add_argument('--load', default = True, help='Whether to use pretrained or not')
    ...
    parser.add_argument('--modality4', type=str, choices=['1', '2', '3'], required=True, help='Student teacher interaction type')
