...
class GTADataset(VisionDataset):
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        if self.flag:
            ...
            image = Image.open(gta_root + self.list_samples[index])
            ...
            print('idda')
            image = Image.open(self.root + self.list_samples[index] +".jpg")
            target = Image.open(self.root + self.list_samples[index] + ".png")
            use_mapping = False
