...
def get_parser():
    ...
    parser.add_argument('--optimizer', type=str, choices=['SGD', 'other'], required=True, help='optimizer name')
    parser.add_argument('--load_checkpoint', default=False, help='Load checkpoints')
    parser.add_argument('--save_checkpoints', default=False, help='Save checkpoints')
